...
void System :: initialize(){ // Initialize the System object according to the content of the input files in the ../INPUT/ directory
  ...
  ifstream Primes("../INPUT_Ex_07_2/Primes");
  Primes >> p1 >> p2 ;
  Primes.close();
  int seed[4]; // Read the seed of the RNG
  ifstream Seed("../INPUT_Ex_07_2/seed.in");
  Seed >> seed[0] >> seed[1] >> seed[2] >> seed[3];
  _rnd.SetRandom(seed,p1,p2);

  ofstream couta("../OUTPUT_Ex_07_2/acceptance.dat"); // Set the heading line in file ../OUTPUT_Ex_07_2/acceptance.dat
  couta << "#   N_BLOCK:  ACCEPTANCE:" << endl;
  couta.close();

  ifstream input("../INPUT_Ex_07_2/input.dat"); // Start reading ../INPUT_Ex_07_2/input.dat
  ofstream coutf;
  coutf.open("../OUTPUT_Ex_07_2/output.dat");
  string property;
  double delta;
  while ( !input.eof() ){
    input >> property;
...
void System :: initialize_velocities(){
  ...
  if(_restart){
    ifstream cinf;
    cinf.open("../INPUT_Ex_07_2/CONFIG/conf-1.xyz");
    if(cinf.is_open()){
      string comment;
      string particle;
      int ncoord;
...
void System :: initialize_properties(){ // Initialize data members used for measurement of properties
  ...
  ifstream input("../INPUT_Ex_07_2/properties.dat");
  if (input.is_open()){
    while ( !input.eof() ){
      input >> property;
      if( property == "POTENTIAL_ENERGY" ){
        ofstream coutp("../OUTPUT_Ex_07_2/potential_energy.dat");
        ...
        ofstream coutk("../OUTPUT_Ex_07_2/kinetic_energy.dat");
        ...
        ofstream coutt("../OUTPUT_Ex_07_2/total_energy.dat");
        ...
        ofstream coutte("../OUTPUT_Ex_07_2/temperature.dat");
        ...
        ofstream coutpr("../OUTPUT_Ex_07_2/pressure.dat");
        ...
        ofstream coutgr("../OUTPUT_Ex_07_2/gofr.dat");
        ...
        ofstream coutpv("../OUTPUT_Ex_07_2/pofv.dat");
        ...
        ofstream coutpr("../OUTPUT_Ex_07_2/magnetization.dat");
        ...
        ofstream coutpr("../OUTPUT_Ex_07_2/specific_heat.dat");
        ...
        ofstream coutpr("../OUTPUT_Ex_07_2/susceptibility.dat");
        ...
        ofstream coutf;
        coutf.open("../OUTPUT_Ex_07_2/output.dat",ios::app);
...
void System :: write_configuration(){
  ofstream coutf;
  if(_sim_type < 2){
    coutf.open("../OUTPUT_Ex_07_2/CONFIG/config.xyz");
    if(coutf.is_open()){
      coutf << _npart << endl;
      coutf << "#Comment!" << endl;
      for(int i=0; i<_npart; i++){
    ...
    coutf.close();
    coutf.open("../OUTPUT_Ex_07_2/CONFIG/conf-1.xyz");
    if(coutf.is_open()){
      coutf << _npart << endl;
      coutf << "#Comment!" << endl;
      for(int i=0; i<_npart; i++){
    ...
    coutf.open("../OUTPUT_Ex_07_2/CONFIG/config.spin");
...
void System :: write_XYZ(int nconf){
  // ofstream coutf;
  // coutf.open("../OUTPUT_Ex_07_2/CONFIG/config_" + to_string(nconf) + ".xyz");
  // if(coutf.is_open()){
  //   coutf << _npart << endl;
  //   coutf << "#Comment!" << endl;
  //   for(int i=0; i<_npart; i++){
...
void System :: read_configuration(){
  ifstream cinf;
  cinf.open("../INPUT_Ex_07_2/CONFIG/config.fcc"); //Ho sostituito config.xyz con config.fcc
  if(cinf.is_open()){
    string comment;
    string particle;
    double x, y, z;
  ...
  if(_restart and _sim_type > 1){
    int spin;
    cinf.open("../OUTPUT_Ex_07_2/CONFIG/config.spin");
    for(int i=0; i<_npart; i++){
      cinf >> spin;
...
void System :: averages(int blk){
  ...
  // POTENTIAL ENERGY //////////////////////////////////////////////////////////
  if (_measure_penergy){
    coutf.open("../OUTPUT_Ex_07_2/potential_energy.dat",ios::app);
  ...
  // KINETIC ENERGY ////////////////////////////////////////////////////////////
  if (_measure_kenergy){
    coutf.open("../OUTPUT_Ex_07_2/kinetic_energy.dat",ios::app);
  ...
  // TOTAL ENERGY //////////////////////////////////////////////////////////////
  if (_measure_tenergy){
    coutf.open("../OUTPUT_Ex_07_2/total_energy.dat",ios::app);
  ...
  // TEMPERATURE ///////////////////////////////////////////////////////////////
  if (_measure_temp){
    coutf.open("../OUTPUT_Ex_07_2/temperature.dat",ios::app);
  ...
  if (_measure_pofv){
    coutf.open("../OUTPUT_Ex_07_2/pofv.dat",ios::app);
  ...
  if (_measure_magnet){
    coutf.open("../OUTPUT_Ex_07_2/magnetization.dat",ios::app);
  ...
  // SPECIFIC HEAT /////////////////////////////////////////////////////////////
  if (_measure_cv){
  coutf.open("../OUTPUT_Ex_07_2/specific_heat.dat",ios::app);
  ...
  // SUSCEPTIBILITY ////////////////////////////////////////////////////////////
  if (_measure_chi){
    coutf.open("../OUTPUT_Ex_07_2/susceptibility.dat",ios::app);
  ...
  // ACCEPTANCE ////////////////////////////////////////////////////////////////
  double fraction;
  coutf.open("../OUTPUT_Ex_07_2/acceptance.dat",ios::app);
